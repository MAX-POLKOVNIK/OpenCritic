...
extension String {
    func htmlToAttributedString(font: Font = .body, color: UIColor = .label) -> AttributedString {
        let data = Data(utf8)
        ...
        mutableAttributedString.setFontFace(font: .preferredFont(from: font), color: color)
